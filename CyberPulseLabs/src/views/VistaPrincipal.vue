...
<template>
    ...
    <main class="flex flex-col items-center gap-6 m-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 w-full max-w-5xl">
            <div class="card bg-base-200 shadow-md shadow-primary cursor-pointer hover:bg-base-300 transition" @click="$router.push('/operaciones')">
                <div class="card-body">
            ...
            <div class="card bg-base-200 shadow-md shadow-primary cursor-pointer hover:bg-base-300 transition" @click="$router.push('/equipos')">
                <div class="card-body">
                    <div class="flex gap-2">
            ...
            <div class="card bg-base-200 shadow-md shadow-primary cursor-pointer hover:bg-base-300 transition" @click="$router.push('/agentes')">
                <div class="card-body">
                    <div class="flex gap-2">
        ...
        <!-- Consola de estado -->
        <div class="mockup-code bg-base-200 mt-8 w-full max-w-4xl shadow-md">
