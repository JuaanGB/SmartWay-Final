<script setup>
    ...
    const inicial = computed(() => props.nombre.charAt(0) || '?')
    ...
    <div class="card bg-base-200 border border-primary shadow-md w-50 h-70 content-center shadow-md">
        <div class="card-body items-center justify-center">
            ...
            <div v-if="!editModeActive" class="flex flex-col items-center gap-2">
                ...
                <!-- Botón de editar -->
                <button v-if="sesion.isAdmin || sesion.agenteId == props.id" @click="toggleEditMode" class="inline-flex lg:hidden btn btn-primary btn-circle btn-sm absolute top-2 right-2">
                ...
                <!-- Botón de eliminar -->
                <button v-if="props.editable && sesion.isAdmin" @click="deleteAgente" class="inline-flex lg:hidden btn btn-primary btn-circle btn-sm absolute top-2 left-2">
