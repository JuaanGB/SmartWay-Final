    ...
    <div class="w-full m-1 overflow-x-auto overflow-y-auto h-80">
      <table class="min-w-[600px] mx-auto table table-pin-rows max-w-3/4 border rounded-box border-base-content/5">
        <thead class="bg-base-200">
          <tr>
            <th v-if="sesion.isAdmin" class="min-w-28">
            ...
            <th class="min-w-70">ID</th>
            <th class="min-w-50">Nombre</th>
            <th class="min-w-40">Estado</th>
            <th class="min-w-50">Inicio</th>
            <th class="min-w-50">Fin</th>
          </tr>
        </thead>
        <tbody>
          <FilaTablaNuevaOperacion v-if="sesion.isAdmin"></FilaTablaNuevaOperacion>
