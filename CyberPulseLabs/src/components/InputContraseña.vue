...
const props = defineProps(['titulo','placeholder'])
...
<template>
    ...
    <fieldset class="fieldset">
        <legend class="fieldset-legend">{{ props.titulo }}</legend>
        <div class="relative">
            <input v-model="model" id="contraseña" :type="mostrar ? 'text' : 'password'" class="input w-full" :placeholder="props.placeholder" />
