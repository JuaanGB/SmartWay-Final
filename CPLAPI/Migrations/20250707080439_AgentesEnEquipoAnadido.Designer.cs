...
namespace CPLAPI.Migrations
{
    ...
    [Migration("20250707080439_AgentesEnEquipoAnadido")]
    partial class AgentesEnEquipoAnadido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CPLAPI.Models.AgenteEnEquipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CPLAPI.Models.AgenteEnEquipo", b =>
                {
                    b.HasOne("CPLAPI.Models.Equipo", null)
                        .WithMany("Agentes")
                        .HasForeignKey("EquipoId");
                });
